    ...
    >
      ...
      >
        <a href="/" className="flex items-center gap-1">
          <img
            className="h-8 w-8 translate-x-0.5 translate-y-0.5 md:h-10 md:w-10"
            src="./../public/assets/icons/logo-krili-green-transformed.png"
            alt="K"
          />

          <span className="hidden text-4xl font-bold text-primary md:block">
            rili
          </span>
        </a>
